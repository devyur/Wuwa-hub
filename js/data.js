...
var HEROES = [
  ...
  { id: "lingyang",       name: "Lingyang",        element: "Glacio",   rarity: "4*", canUseMultiple: false },
  { id: "calcharo",       name: "Calcharo",        element: "Electro",  rarity: "4*", canUseMultiple: false },
  { id: "encore",         name: "Encore",          element: "Fusion",   rarity: "4*", canUseMultiple: false },
  { id: "verina",         name: "Verina",          element: "Spectro",  rarity: "4*", canUseMultiple: true },
  { id: "rover_havoc",    name: "Rover (Havoc)",   element: "Havoc",    rarity: "4*", canUseMultiple: false },
  { id: "rover_spectro",  name: "Rover (Spectro)", element: "Spectro",  rarity: "4*", canUseMultiple: false },
  { id: "rover_aero",     name: "Rover (Aero)",    element: "Aero",     rarity: "4*", canUseMultiple: false },
  ...
  { id: "rebecca",        name: "Rebecca",         element: "Electro",  rarity: "5*", canUseMultiple: false },
  { id: "lucilla",        name: "Lucilla",         element: "Glacio",   rarity: "5*", canUseMultiple: false },
  { id: "lucy",           name: "Lucy",            element: "Spectro",  rarity: "5*", canUseMultiple: false },
];
